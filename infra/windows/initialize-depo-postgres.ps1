...
Write-Host 'Cluster initialized with password authentication. Configure listen address, TLS, port, access rules and backup policy before starting it. See infra/postgres/README.md.'
