...
export const workflowCatalog = [
  ...
  },
  {
    ...
    category: 'Mapping',
    description: 'Align one imported instance artifact to one ontology using instance entities, attributes, relationships, and metadata. Use the merge workflow for ontology-to-ontology work.',
    inputs: 'One imported instance artifact plus one target ontology',
    outputs: ['Bridge candidates', 'Applied semantic links', 'Confidence and validation report'],
    status: 'available',
    execution: 'Artifact workflow',
    prerequisite: 'Run an import first, then select the instance and the target ontology',
    icon: Link2,
    stages: ['Select imported instance', 'Select target ontology', 'Preview bridge candidates', 'Review and apply'],
    writes_to_neo4j: true,
    retains_artifacts: true,
  },
  {
