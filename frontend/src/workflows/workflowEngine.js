...
export const workflowCatalog = [
  ...
  },
  {
    ...
    category: 'Mapping',
    description: 'Select an imported artifact, resolve a target ontology, then apply semantic links onto the instance graph.',
    ...
    icon: Link2,
    stages: ['Select latest import', 'Select ontology', 'Generate candidates', 'Apply semantic links'],
    writes_to_neo4j: true,
    retains_artifacts: true,
  },
  {
