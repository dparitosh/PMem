...
export const workflowCatalog = [
  ...
  },
  {
    ...
    category: 'Mapping',
    description: 'Align instance entities, attributes, relationships, and metadata to ontology classes and properties, with optional ontology-to-ontology comparison.',
    inputs: 'Imported instance artifacts plus an ontology',
    outputs: ['Bridge candidates', 'Applied semantic links', 'Confidence and validation report'],
    status: 'available',
    execution: 'Artifact workflow',
    prerequisite: 'Run an import first, then select an ontology',
    icon: Link2,
    stages: ['Select active instance', 'Select ontology anchor', 'Generate bridge candidates', 'Review and apply'],
    writes_to_neo4j: true,
    retains_artifacts: true,
  },
  {
    ...
    category: 'Ontology',
    description: 'Compare two ontologies and produce a merge plan; a direct Neo4j merge action is available from the workflow surface when you are ready to commit.',
