...
const WORKFLOW_OPTIONS = [
  ...
  },
  {
    ...
    status: 'available',
    icon: Link2,
    stages: ['Select latest import', 'Select ontology', 'Generate candidates', 'Review artifact'],
...
const isImportWorkflow = (workflowId) => workflowId === 'instance.import' || workflowId === 'ontology.create';
