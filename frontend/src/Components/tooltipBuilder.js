...
export function buildTooltipHeader(nodeType, closeBtnHtml = '') {
  return `
    <div class="dt-tooltip-header" style="position:relative; background: linear-gradient(135deg, #1F3D63 0%, #486581 100%); color: white; padding: 10px 14px; margin: -10px -12px 10px -12px; font-weight: 700; border-radius: 10px 10px 0 0;">
