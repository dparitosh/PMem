...
STANDARDS = {
    ...
    "ap242": {"name": "STEP AP242", "prefix": "ap242", "tokens": ("ap242", "step"), "reference_root": ""},
...
def public_standards() -> list[dict]:
    return [{"id": identifier, "name": profile["name"], "default_prefix": profile["prefix"], "reference_available": bool(profile["reference_root"])} for identifier, profile in STANDARDS.items()]
