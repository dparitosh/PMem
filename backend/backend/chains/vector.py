...
def _require_chains():
    if not general_retrieval_chain or not data_retrieval_chain:
        raise RuntimeError(
            "LLM/EMBEDDER MODEL NOT AVAILABLE – vector search is disabled. "
            "Check backend logs and ensure Ollama/Azure is reachable."
        )
